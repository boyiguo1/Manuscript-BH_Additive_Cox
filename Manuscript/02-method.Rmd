...
$$
h(t|\bs x) = h_0(t)exp(a + \sum\limits^p_{j=1}f_j(x_j)),\qquad E[f_j(x_j)] = 0.
$$
...
$$
\lambda(t|x_i) = \lambda_0(t)\exp\left[\bs X_i^T \bs \beta\right],
$$
...
\subsection{Alforithm for fitting ss Cox Spline Models}
...
\subsubsection{Other Mixture Priors and Algorithm}
